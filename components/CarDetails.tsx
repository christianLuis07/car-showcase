                ...
                <div className="flex-1 flex flex-col gap-3">
                  ...
                  <div className="flex gap-3">
                    <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                      <Image
                        src={car.images?.angleFront || generateCarImageUrl(car, "29")}
                        alt="car model"
                        fill
                        priority
                        className="object-contain"
                    ...
                    <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                      <Image
                        src={car.images?.angleSide || generateCarImageUrl(car, "33")}
                        alt="car model"
                        fill
                        priority
                        className="object-contain"
                    ...
                    <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                      <Image
                        src={car.images?.interior || generateCarImageUrl(car, "13")}
                        alt="car model"
                        fill
                        priority
                        className="object-contain"
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <div className="mt-3 flex flex-wrap gap-4">
                    ...
                    <div className="flex justify-between gap-5 w-full text-right">
                      ...
                      <p className="text-black-100 font-semibold uppercase">{car.drive}</p>
                    </div>
                    <div className="flex justify-between gap-5 w-full text-right">
                      <h4 className="text-grey capitalize">Fuel Type</h4>
                      <p className="text-black-100 font-semibold capitalize">{car.fuel_type}</p>
                    </div>
                    <div className="flex justify-between gap-5 w-full text-right">
